        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-lg font-medium">AI Health Bridge</h1>
              {isDoctor && (
            ...
            <div className="flex items-center space-x-4">
              <ConnectionStatus />
              <div className={`w-8 h-8 rounded-full ${isDoctor ? 'bg-primary' : 'bg-neutral-dark'} flex items-center justify-center`}>
